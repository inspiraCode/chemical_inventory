...
<body>
    ...
    <script type="text/javascript">
        ...
        function getChemicals() {
            jQuery.getJSON('<%= ResolveUrl("~/WebService/Catalogs.aspx") %>?cmd=read&catalog=chemicals', function (result) {
                Chemicals = result;
                readCallBack();
            });
            return true;
        ...
        function populateChemicals() {
            ...
            for (var i = 0; i < Chemicals.length; i++) {
                ...
                var arrCells = [
                        ...
                        '<img src="images/file-icon.png" alt="ProviderFile" onclick="on_ProviderFile_click('
								+ current.ID + ',this);return false;"'
								+ ' style="height:20px;cursor:pointer;" />',
                        current.Container,
                        current.Status,
